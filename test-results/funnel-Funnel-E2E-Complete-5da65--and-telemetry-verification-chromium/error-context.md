...
- generic [active] [ref=e1]:
  ...
  - alert [ref=e20]: تِذكار - دعوة تبقى بالذكرى
  - generic [ref=e22]:
    - generic [ref=e23]: ⚠️
    - heading "حدث خطأ" [level=1] [ref=e24]
    - paragraph [ref=e25]: هذا القالب قيد التطوير وغير متاح للاستخدام
    - link "العودة للقوالب" [ref=e26] [cursor=pointer]:
      - /url: /templates
```
