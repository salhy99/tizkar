...
- Name: golden-path.spec.ts >> Golden Path >> Payment Order & Admin Confirmation & Publish
- Location: tests\e2e\golden-path.spec.ts:130:18
...
Expected pattern: /\/editor\/.+\/share/
Received string:  "http://localhost:3000/editor/f310db9d-89ca-407c-ad86-621c990bc983"
Timeout: 10000ms

Call log:
  - Expect "toHaveURL" with timeout 10000ms
    14 × locator resolved to <html lang="ar" dir="rtl" class="cairo_c24d5e45-module__3UB79a__variable font-cairo antialiased h-full selection:bg-primary/20 selection:text-primary">…</html>
       - unexpected value "http://localhost:3000/editor/f310db9d-89ca-407c-ad86-621c990bc983"
...
- banner:
  ...
  - button "سجل الحضور"
  - button "معاينة"
  - button "جاري النشر..." [disabled]
- complementary:
  - heading "اكتمال دعوتك" [level=2]
  - text: 100%
  - heading "الباقة الحالية" [level=3]:
    - button "الباقة الحالية" [expanded]
  - region "الباقة الحالية":
    - text: UNKNOWN مفعل عدد الصور حتى 5 موسيقى خلفية غير متاحة تأكيد الحضور (RSVP) حتى 50
    - link "ترقية أو إدارة الباقة":
      - /url: /dashboard/plans/f310db9d-89ca-407c-ad86-621c990bc983
      - button "ترقية أو إدارة الباقة"
...
- main:
  ...
  - heading "عريس E2E-1788216186661-2000" [level=1]
  - text: "&"
  - heading "عروس E2E-1788216186661-2000" [level=1]
  ...
  - text: 49 أيام 17 ساعة 13 دقيقة 57 ثانية 📍
