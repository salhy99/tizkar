...
- generic [active] [ref=e1]:
  ...
  - alert [ref=e12]: حدث خطأ
  - generic [ref=e14]:
    - generic [ref=e15]: ⚠️
    - heading "حدث خطأ" [level=1] [ref=e16]
    - paragraph [ref=e17]: هذا القالب قيد التطوير وغير متاح للاستخدام
    - link "العودة للقوالب" [ref=e18] [cursor=pointer]:
      - /url: /templates
```
